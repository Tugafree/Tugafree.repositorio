...
def CATEGORIES():
	addDir('','http://pastebin.com/raw.php?i=s1RAg4b9',2,os.path.join(artfolder,'11.png'))
	addDir('','http://pastebin.com/raw.php?i=Fkksnp46',2,os.path.join(artfolder,'12.png'))
	addDir('','http://pastebin.com/raw.php?i=BNG689AA',2,os.path.join(artfolder,'13.png'))
	addDir('','http://pastebin.com/raw.php?i=EsKaW27w',2,os.path.join(artfolder,'14.png'))
	addDir('','http://pastebin.com/raw.php?i=9ycvdZJ2',2,os.path.join(artfolder,'15.png'))
	addDir('','http://pastebin.com/raw.php?i=Zqsbc5bG',2,os.path.join(artfolder,'16.png'))
	addDir('','http://pastebin.com/raw.php?i=8e76Mgj6',2,os.path.join(artfolder,'17.png'))	
	addDir('','http://pastebin.com/raw.php?i=ixC8uQF0',2,os.path.join(artfolder,'18.png'))
	addDir('','http://pastebin.com/raw.php?i=E1bhsjFt',2,os.path.join(artfolder,'19.png'))
