...
def CATEGORIES():
	addDir('','https://dl.dropboxusercontent.com/s/was597aqw3z9o4o/Desportotugafree.txt?dl=0',2,os.path.join(artfolder,'11.png'))
	addDir('','https://dl.dropboxusercontent.com/s/4t0mfcvpyorqbd4/Desportointernacionaltugafree.txt?dl=0',2,os.path.join(artfolder,'12.png'))
	addDir('','https://dl.dropboxusercontent.com/s/lg1bmiv35lqpuyx/Generalistastugafree.txt?dl=0',2,os.path.join(artfolder,'13.png'))
	addDir('','https://dl.dropboxusercontent.com/s/71d5iyi4ethuqnx/Noticiastugafree.txt?dl=0',2,os.path.join(artfolder,'14.png'))
	addDir('','https://dl.dropboxusercontent.com/s/jwqqo1b3esfx7db/Filmestugafree.txt?dl=0',2,os.path.join(artfolder,'15.png'))
	addDir('','https://dl.dropboxusercontent.com/s/1okynxjd7qi4vqe/Musicatugafree.txt?dl=0',2,os.path.join(artfolder,'16.png'))
	addDir('','https://dl.dropboxusercontent.com/s/yn3ta1e69jtpovo/Infantiltugafree.txt?dl=0',2,os.path.join(artfolder,'17.png'))	
	addDir('','https://dl.dropboxusercontent.com/s/2h68dy50u2x1xxv/Eventostugafree.txt?dl=0',2,os.path.join(artfolder,'18.png'))
	addDir('','https://dl.dropboxusercontent.com/s/36iyzhbh5bn7qh7/Acetugafree.txt?dl=0',2,os.path.join(artfolder,'19.png'))
