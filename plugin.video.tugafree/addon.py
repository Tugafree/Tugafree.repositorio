...
def CATEGORIES():
	addDir('','https://dl.dropboxusercontent.com/s/2gto290vp6cw3mz/Desportotugafree.txt?dl=0',2,os.path.join(artfolder,'11.png'))
	addDir('','https://dl.dropboxusercontent.com/s/ggjbgs8bfycfzrk/Desportointernacionaltugafree.txt?dl=0',2,os.path.join(artfolder,'12.png'))
	addDir('','https://dl.dropboxusercontent.com/s/4brsa0zrady9s9l/Generalistastugafree.txt?dl=0',2,os.path.join(artfolder,'13.png'))
	addDir('','https://dl.dropboxusercontent.com/s/3ua9j8zcki0wx5l/Noticiastugafree.txt?dl=0',2,os.path.join(artfolder,'14.png'))
	addDir('','https://dl.dropboxusercontent.com/s/i2ck5oi17lmmqxu/Filmestugafree.txt?dl=0',2,os.path.join(artfolder,'15.png'))
	addDir('','https://dl.dropboxusercontent.com/s/7es7qo96o6jl5tt/Musicatugafree.txt?dl=0',2,os.path.join(artfolder,'16.png'))
	addDir('','https://dl.dropboxusercontent.com/s/j1wkbn8kwh4rn48/Infantiltugafree.txt?dl=0',2,os.path.join(artfolder,'17.png'))	
	addDir('','https://dl.dropboxusercontent.com/s/snvxs9cs6hbrip8/Eventostugafree.txt?dl=0',2,os.path.join(artfolder,'18.png'))
	addDir('','https://dl.dropboxusercontent.com/s/hejem4mnrjtei07/Acetugafree.txt?dl=0',2,os.path.join(artfolder,'19.png'))
